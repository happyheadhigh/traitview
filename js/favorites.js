...
function syncFavoritesUI(){
  ...
  // Mirrors the toggle button's own state into the same always-visible pill
  // row the trait/jump filters use, above the grid -- see updateActivePills
  // in app.js. Guarded: favorites.js executes before app.js (script order),
  // but this only actually runs later via setTimeout/toggle/storage events,
  // by which point app.js has defined it.
